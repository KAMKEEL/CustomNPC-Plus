...
public interface IAbilityExtender {
     ...
     * @param damageRatio   Proportional damage factor from barrier interactions (0.0-1.0).
     *                      1.0 means full damage (no barrier reduction). Extenders that
     *                      recalculate damage from stats should multiply by this ratio.
