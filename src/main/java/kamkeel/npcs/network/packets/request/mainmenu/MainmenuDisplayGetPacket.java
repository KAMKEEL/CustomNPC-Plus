...
public final class MainmenuDisplayGetPacket extends AbstractPacket {
    public static String packetName = "Request|MainmenuDisplayGet";

    public MainmenuDisplayGetPacket() {
    }

    @Override
    public Enum getType() {
        return EnumRequestPacket.MainmenuDisplayGet;
    }
