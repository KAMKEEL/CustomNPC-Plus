...
public final class MainmenuInvGetPacket extends AbstractPacket {
    public static String packetName = "Request|MainmenuInvGet";

    public MainmenuInvGetPacket() {
    }

    @Override
    public Enum getType() {
        return EnumRequestPacket.MainmenuInvGet;
    }
