...
public final class TransformSavePacket extends AbstractPacket {
    public static String packetName = "Request|TransformSave";

    public TransformSavePacket() { }

    @Override
    public Enum getType() {
        return EnumRequestPacket.TransformSave;
    }
    ...
    public void receiveData(ByteBuf in, EntityPlayer player) throws IOException {
        ...
        npc.transform.readOptions(ByteBufUtils.readNBT(in));
