...
public final class NaturalSpawnGetAllPacket extends AbstractPacket {
    public static String packetName = "Request|NaturalSpawnGetAll";

    public NaturalSpawnGetAllPacket() {
    }

    @Override
    public Enum getType() {
        return EnumRequestPacket.NaturalSpawnGetAll;
    }
