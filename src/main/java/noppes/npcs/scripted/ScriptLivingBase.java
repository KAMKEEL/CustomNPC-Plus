...
public class ScriptLivingBase extends ScriptEntity{
	...
	/**
	 * Note not all Living Entities support this
	 * @param slot Slot of what armor piece to get, 0:boots, 1:pants, 2:body, 3:head, for npcs its 0:head, 1:body, 2:pants, 3:boots, small mistake on my part
	 ...
	 * Note not all Living Entities support this
	 * @since 1.7.10c
	 * @param slot Slot of what armor piece to set, 0:boots, 1:pants, 2:body, 3:head, for npcs its 0:head, 1:body, 2:pants, 3:boots, small mistake on my part
