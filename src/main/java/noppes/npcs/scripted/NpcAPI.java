...
public class NpcAPI extends AbstractNpcAPI {
    ...
    public static final HashMap<String,ScriptEntityData> playerCache = new HashMap<>();
    ...
    public IEntity<?> getIEntity(Entity entity) {
        ...
        if(entity instanceof EntityNPCInterface)
            ...
            if(entity instanceof EntityPlayerMP) {
                if (!playerCache.containsKey(((EntityPlayerMP) entity).getDisplayName())) {
                    playerCache.put(((EntityPlayerMP) entity).getDisplayName(),new ScriptEntityData(new ScriptPlayer<>((EntityPlayerMP) entity)));
                }
                data = playerCache.get(((EntityPlayerMP) entity).getDisplayName());
            }
