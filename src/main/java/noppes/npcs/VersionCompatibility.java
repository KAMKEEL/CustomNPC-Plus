...
public class VersionCompatibility {
    ...
    public static void CheckNpcCompatibility(EntityNPCInterface npc, NBTTagCompound compound) {
        ...
        if (npc.npcVersion == 12) {
            ...
            if (list.tagCount() == 3) {
                int z = ((NBTTagInt) list.removeTag(2)).func_150287_d(); //get int
                int y = ((NBTTagInt) list.removeTag(1)).func_150287_d(); //get int
                int x = ((NBTTagInt) list.removeTag(0)).func_150287_d(); //get int
