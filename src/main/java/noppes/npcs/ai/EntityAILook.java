...
public class EntityAILook extends EntityAIBase {
    ...
    public void startExecuting() {
        rotatebody = npc.ais.standingType == EnumStandingType.RotateBody || npc.ais.standingType == EnumStandingType.HeadRotation;
    }
    ...
    public void updateTask() {
        if (npc.ais.standingType == EnumStandingType.Stalking) {
        ...
        if (rotatebody) {
            if (idle == 0 && npc.getRNG().nextFloat() < 0.02F) {
                ...
                if (npc.ais.standingType == EnumStandingType.HeadRotation)
        ...
        if (npc.ais.standingType == EnumStandingType.NoRotation) {
