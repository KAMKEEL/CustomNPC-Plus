...
public class PathNavigateSwimmer extends PathNavigateNPC
{
    ...
    {
        return new NPCPathFinder(new SwimNodeProcessor());
    }
    ...
    {
        return new Vec3NPC(this.theEntity.posX, this.theEntity.posY + (double)this.theEntity.height * 0.5D, this.theEntity.posZ);
    }
    ...
    {
        MovingObjectPosition movingobjectposition = this.worldObj.func_147447_a(posVec31, new Vec3NPC(posVec32.xCoord, posVec32.yCoord + (double)this.theEntity.height * 0.5D, posVec32.zCoord), false, true, false);
