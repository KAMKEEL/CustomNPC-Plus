...
/**
 * Handles writing/reading item attributes.
 * Non‑magic attributes are stored under a "CNPCAttributes" tag.
 * Magic-based attributes are stored as a compound mapping magic ID to value,
 * for example under "cnpc:magic_damage_flat".
 */
