...
public class SubGuiTrapPresetSelector extends SubGuiInterface {
    ...
    private static final String[] PRESET_LABELS = {
        "ability.preset.hidden", "ability.preset.venom", "ability.preset.explosive",
        "ability.preset.cursed", "ability.preset.shock", "ability.preset.snare"
    };
    private static final int[] PRESET_COLORS = {0x888888, 0x44DD44, 0xFF6611, 0xAA44FF, 0x4488FF, 0x88CCFF};

    public SubGuiTrapPresetSelector() {
        xSize = 170;
        ySize = 135;
