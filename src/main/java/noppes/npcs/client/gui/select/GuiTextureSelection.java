...
//
//	private HashMap<String,List<TextureData>> domains = new HashMap<String,List<TextureData>>();
...
//        	List<IResourcePack> list = ObfuscationReflectionHelper.getPrivateValue(FallbackResourceManager.class, manager, 1);
//        	for(IResourcePack pack : list){
//        		if(pack instanceof LegacyV2Adapter) {
//        			pack = ObfuscationReflectionHelper.getPrivateValue(LegacyV2Adapter.class, (LegacyV2Adapter)pack, 0);;
//        		}
...
//    		}
//    		catch(Throwable e) {
//    			LogWriter.error("error with: " + name, e);
//    		}
//    	}
//	}
