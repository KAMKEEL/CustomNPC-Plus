...
public class CustomOverlayLabel extends Gui implements IOverlayComponent {
    ...
    private final boolean bidiFlag = false;
    private final boolean unicodeFlag = false;
        ...
        {
            {
                ...
                if (this.strikethroughStyle) {
                    ...
                    tessellator.addVertex(this.posX, this.posY + (float) (Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT / 2), 0.0D);
                    tessellator.addVertex(this.posX + f, this.posY + (float) (Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT / 2), 0.0D);
                    tessellator.addVertex(this.posX + f, this.posY + (float) (Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT / 2) - 1.0F, 0.0D);
                    tessellator.addVertex(this.posX, this.posY + (float) (Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT / 2) - 1.0F, 0.0D);
                    tessellator.draw();
                ...
                if (this.underlineStyle) {
                    ...
                    tessellator.addVertex(this.posX + (float) l, this.posY + (float) Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT, 0.0D);
                    tessellator.addVertex(this.posX + f, this.posY + (float) Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT, 0.0D);
                    tessellator.addVertex(this.posX + f, this.posY + (float) Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT - 1.0F, 0.0D);
                    tessellator.addVertex(this.posX + (float) l, this.posY + (float) Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT - 1.0F, 0.0D);
                    tessellator.draw();
                    GL11.glEnable(GL11.GL_TEXTURE_2D);
                }
