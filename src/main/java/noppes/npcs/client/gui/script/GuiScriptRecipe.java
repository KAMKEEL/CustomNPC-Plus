...
public class GuiScriptRecipe extends GuiNPCInterface implements GuiYesNoCallback, IGuiData, ITextChangeListener, ICustomScrollListener, IJTextAreaListener, ITextfieldListener {
    ...
    public final GuiNpcManageRecipes parent;
    ...
    public GuiScriptRecipe(GuiNpcManageRecipes parent, RecipeCarpentry recipe) {
        ...
        this.scriptHandler = new RecipeScript();
        this.anvil = false;
    ...
    public void save() {
        if (loaded) {
            ...
            for (int i = 0; i < containers.size(); i++) {
                ...
                RecipeScriptPacket.Save(anvil, recipeId, i, containers.size(), container.writeToNBT(new NBTTagCompound()));
            }
            ...
            RecipeScriptPacket.Save(anvil, recipeId, -1, containers.size(), scriptData);
        }
    }
