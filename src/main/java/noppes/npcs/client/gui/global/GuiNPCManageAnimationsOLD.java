...
public class GuiNPCManageAnimationsOLD extends GuiModelInterface implements IScrollData, ITextfieldListener, ICustomScrollListener, IGuiData {
    ...
    public GuiNPCManageAnimationsOLD(EntityNPCInterface npc) {
    ...
    protected void actionPerformed(GuiButton guibutton){
        ...
        if (guibutton.id == 1) {
            ...
            Client.sendData(EnumPacketServer.AnimationRemove, scroll.getSelected());
