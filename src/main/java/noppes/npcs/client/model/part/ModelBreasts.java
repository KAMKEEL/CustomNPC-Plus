...
public class ModelBreasts extends ModelPartInterface {
	...
	public ModelBreasts(ModelMPM base) {
		...
		breasts = new Model2DRenderer(base, 20f, 22, 8, 3, 64, 64);
		...
		Model2DRenderer bottom = new Model2DRenderer(base, 20f, 22, 8, 4, 64, 64);
		...
		Model2DRenderer right = new Model2DRenderer(base, 20f, 22, 3, 2, 64, 64);
		right.setRotationPoint(-3.8F, 5.3f, -3.6f);
		right.setScale(0.12f, 0.14f);
		right.setThickness(1.75f);
		breasts3.addChild(right);
		
		Model2DRenderer right2 = new Model2DRenderer(base, 20f, 22, 3, 1, 64, 64);
		...
		Model2DRenderer right3 = new Model2DRenderer(base, 20f, 24, 3, 1, 64, 64);
		...
		Model2DRenderer right4 = new Model2DRenderer(base, 23f, 22, 1, 2, 64, 64);
		...
		Model2DRenderer left = new Model2DRenderer(base, 25f, 22, 3, 2, 64, 64);
		left.setRotationPoint(0.8F, 5.3f, -3.6f);
		left.setScale(0.12f, 0.14f);
		left.setThickness(1.75f);
		breasts3.addChild(left);
		
		Model2DRenderer left2 = new Model2DRenderer(base, 25f, 22, 3, 1, 64, 64);
		...
		Model2DRenderer left3 = new Model2DRenderer(base, 25f, 24, 3, 1, 64, 64);
		...
		Model2DRenderer left4 = new Model2DRenderer(base, 24f, 22, 1, 2, 64, 64);
