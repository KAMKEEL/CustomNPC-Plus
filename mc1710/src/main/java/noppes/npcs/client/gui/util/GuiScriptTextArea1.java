 ...
 */
public class GuiScriptTextArea1 extends GuiNpcTextField {
    ...
    public void setCallbacks() {
        searchBar.setCallback(new SearchReplaceBar.SearchCallback() {
            ...
            public String getText() {
                return GuiScriptTextArea1.this.text;
            }
            ...
            public void setText(String newText) {
                GuiScriptTextArea1.this.setText(newText);
            }
            ...
            public void scrollToPosition(int position) {
                ...
                int effectiveHeight = GuiScriptTextArea1.this.height - searchBarOffset;
            ...
            public void resizeEditor(boolean open, int barHeight) {
                ...
                if (!searchBaseInitialized) {
                    searchBaseY = GuiScriptTextArea1.this.y;
                    searchBaseHeight = GuiScriptTextArea1.this.height;
                ...
                GuiScriptTextArea1.this.height = newHeight;
                searchAppliedOffset = targetOffset;

                if (container != null)
                    container.visibleLines = Math.max(GuiScriptTextArea1.this.height / container.lineHeight - 1, 1);
            }
        });
        ...
        goToLineDialog.setCallback(new GoToLineDialog.GoToLineCallback() {
            ...
            public void goToLineColumn(int line, int column) {
                ...
                int visible = GuiScriptTextArea1.this.height / (container != null ? container.lineHeight : 12);
                int effectiveVisible = Math.max(1, visible - bottomPaddingLines);
                int maxScroll = Math.max(0, getPaddedLineCount() - visible);
    ...
    public void drawTextBox(int xMouse, int yMouse) {
        ...
        for (int i = renderStart; i <= renderEnd; i++) {
            ...
            ScriptLine scriptLine = container.getDocument().getLineAt(i);
    ...
    public void setText(String text) {
        ...
        if (this.text == null || !this.text.equals(text)) {
            ...
            if (!this.undoing) {
                this.undoList.add(new GuiScriptTextArea1.UndoData(this.text, selection.getCursorPosition()));
                this.redoList.clear();
            }
