...
public class QuestLocation extends QuestInterface implements IQuestLocation {
    ...
    public Vector<String> getQuestLogStatus(IPlayer player) {
        ...
        if (data == null)
            return vec;
        String found = PlatformServiceHolder.get().translateToLocal("quest.found");
        String notfound = PlatformServiceHolder.get().translateToLocal("quest.notfound");
    ...
    public boolean setFoundParty(Party party, IPlayer player, String location, boolean isLeader) {
    ...
    public boolean setPartyPlayerFound(QuestData data, IPlayer player, String locationFoundKey, int partySize) {
    ...
    class QuestLocationObjective implements IQuestObjective {
        ...
        public QuestLocationObjective(QuestLocation this$0, IPlayer player, String location, String nbtName) {
            this.parent = this$0;
            this.player = player;
