...
public class QuestKill extends QuestInterface implements IQuestKill {
    ...
    public String customTargetType = "noppes.npcs.IEntity.EntityCustomNpc";
    ...
    public boolean isCompleted(PlayerData playerData) {
        ...
        if (killed.size() != targets.size())
            return false;
        for (String IEntity : killed.keySet()) {
            if (!targets.containsKey(IEntity) || targets.get(IEntity) > killed.get(IEntity))
                return false;
        }
    ...
    class QuestKillObjective implements IQuestObjective {
        ...
        public QuestKillObjective(QuestKill parent, IPlayer player, String IEntity, int amount) {
            this.parent = parent;
            this.player = player;
        ...
        public QuestKillObjective(QuestKill parent, Party party, String IEntity, int amount) {
            this.parent = parent;
            this.party = party;
            this.IEntity = IEntity;
            this.amount = amount;
        ...
        public int getProgress() {
            if (player != null) {
                ...
                if (questdata != null) {
                    ...
                    return !killed.containsKey(this.IEntity) ? 0 : (Integer) killed.get(this.IEntity);
                }
            } else if (party != null) {
                ...
                if (questdata != null) {
                    if (questdata.quest.partyOptions.objectiveRequirement == EnumPartyObjectives.All) {
                        ...
                        for (String player : party.getPlayerNames()) {
                            ...
                            int currentProgress = !killed.containsKey(this.IEntity) ? 0 : (Integer) killed.get(this.IEntity);
        ...
        public void setProgress(int progress) {
            if (progress >= 0 && progress <= this.amount) {
                if (player != null) {
                    ...
                    if (questdata != null) {
                        HashMap<String, Integer> killed = this.parent.getKilled(questdata);
                        if (!killed.containsKey(this.IEntity) || (Integer) killed.get(this.IEntity) != progress) {
                            killed.put(this.IEntity, progress);
