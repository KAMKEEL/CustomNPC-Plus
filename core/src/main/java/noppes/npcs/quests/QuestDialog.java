...
public class QuestDialog extends QuestInterface implements IQuestDialog {
    ...
    public Vector<String> getPartyQuestLogStatus(Party party) {
        ...
        if (objectives == EnumPartyObjectives.All) {
            ...
            IPlayer leader = NoppesUtilServer.getPlayer(party.getLeaderUUID());
            PlayerData playerData;
            if (leader != null) {
    ...
    public boolean isPartyCompleted(Party party) {
        ...
        if (objectives == EnumPartyObjectives.All) {
            ...
            for (UUID uuid : party.getPlayerUUIDs()) {
                IPlayer individual = NoppesUtilServer.getPlayer(uuid);
            ...
            IPlayer leaderPlayer = NoppesUtilServer.getPlayer(party.getLeaderUUID());
    ...
    class QuestDialogObjective implements IQuestObjective {
        ...
        public QuestDialogObjective(QuestDialog this$0, IPlayer player, Dialog dialog) {
            this.parent = this$0;
            this.player = player;
            this.dialog = dialog;
            this.party = null;
