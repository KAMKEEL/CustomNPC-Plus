...
public class ConfigMain {
    ...
    public static IConfigProperty EnableUpdateCheckerProperty;
    public static boolean EnableUpdateChecker = true;

    public static IConfigProperty DisableEnchantsProperty;
    public static boolean DisableEnchants = false;

    public static IConfigProperty EnchantStartIdProperty;
    public static int EnchantStartId = 100;

    public static IConfigProperty LeavesDecayEnabledProperty;
    public static boolean LeavesDecayEnabled = true;

    public static IConfigProperty VineGrowthEnabledProperty;
    public static boolean VineGrowthEnabled = true;

    public static IConfigProperty IceMeltsEnabledProperty;
    public static boolean IceMeltsEnabled = true;

    public static IConfigProperty SoulStoneAnimalsProperty;
    public static boolean SoulStoneAnimals = true;

    public static IConfigProperty SoulStoneVillagersProperty;
    public static boolean SoulStoneVillagers = false;

    public static IConfigProperty SoulStoneNPCsProperty;
    public static boolean SoulStoneNPCs = false;

    public static IConfigProperty SoulStoneFriendlyNPCsProperty;
    public static boolean SoulStoneFriendlyNPCs = false;

    public static IConfigProperty DatFormatProperty;
    public static boolean DatFormat = false;

    public static IConfigProperty MarketDatFormatProperty;
    public static boolean MarketDatFormat = false;

    public static IConfigProperty PartiesEnabledProperty;
    public static boolean PartiesEnabled;

    public static IConfigProperty PartyFriendlyFireEnabledProperty;
    public static boolean PartyFriendlyFireEnabled;

    public static IConfigProperty DefaultMinPartySizeProperty;
    public static int DefaultMinPartySize = 1;

    public static IConfigProperty DefaultMaxPartySizeProperty;
    ...
    public static IConfigProperty RegionProfileSwitchingProperty;
    public static boolean RegionProfileSwitching = false;

    public static IConfigProperty RestrictedProfileRegionsProperty;
    ...
    public static IConfigProperty OpsOnlyProperty;
    public static boolean OpsOnly = false;

    public static IConfigProperty NpcNavRangeProperty;
    public static int NpcNavRange = 32;

    public static IConfigProperty NpcSizeLimitProperty;
    public static int NpcSizeLimit = 100;

    public static IConfigProperty DefaultInteractLineProperty;
    public static String DefaultInteractLine = "Hello @p";

    public static IConfigProperty ChunkLoadersProperty;
    public static int ChunkLoaders = 20;

    public static IConfigProperty DialogImageLimitProperty;
    public static int DialogImageLimit = 10;

    public static IConfigProperty SkinOverlayLimitProperty;
    public static int SkinOverlayLimit = 10;

    public static IConfigProperty NpcUseOpCommandsProperty;
    public static boolean NpcUseOpCommands = false;

    public static IConfigProperty HitBoxScaleMaxProperty;
    ...
    public static IConfigProperty TrackedQuestUpdateFrequencyProperty;
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            FMLLog.log(Level.ERROR, e, "CNPC+ has had a problem loading its main IConfiguration");
        } finally {
