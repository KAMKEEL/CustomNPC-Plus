...
public class ConfigClient {
     ...
     * General Properties
     **/
    public static IConfigProperty AllowClientScriptsProperty;
    public static boolean AllowClientScripts = true;

    public static IConfigProperty CacheLifeProperty;
    public static int CacheLife = 10;

    /**
     * Visual Properties
     **/
    public static IConfigProperty EnableChatBubblesProperty;
    public static boolean EnableChatBubbles = true;

    public static IConfigProperty InventoryGuiEnabledProperty;
    public static boolean InventoryGuiEnabled = true;

    public static IConfigProperty enableFactionTabProperty;
    public static boolean enableFactionTab = true;

    public static IConfigProperty FontTypeProperty;
    public static String FontType = "Default";

    public static IConfigProperty FontSizeProperty;
    public static int FontSize = 18;

    public static IConfigProperty ChatBubblesFontTypeProperty;
    public static boolean ChatBubblesFontType = false;

    public static IConfigProperty HideEffectsBarProperty;
    public static boolean HideEffectsBar = false;

    // Rendering Properties
    public static IConfigProperty LowResExplosionProperty;
    public static boolean LowResExplosion = false;

    // Proximity Alpha (owner-only fade for energy projectiles near camera)
    public static IConfigProperty ProximityAlphaMinProperty;
    public static float ProximityAlphaMin = 0.15f;

    public static IConfigProperty ProximityAlphaDistanceProperty;
    public static float ProximityAlphaDistance = 10.0f;

    public static IConfigProperty ProximityAlphaAgeTicksProperty;
    public static int ProximityAlphaAgeTicks = 60;

    /**
     * Questing Properties
     **/
    public static IConfigProperty DialogSpeedProperty;
    public static int DialogSpeed = 10;

    public static IConfigProperty DialogSoundProperty;
    public static boolean DialogSound = true;

    public static IConfigProperty ChatAlertsProperty;
    public static boolean ChatAlerts = true;

    public static IConfigProperty BannerAlertsProperty;
    public static boolean BannerAlerts = true;

    // HUD PROPERTIES
    public static IConfigProperty QuestOverlayXProperty;
    public static float QuestOverlayX = 0;

    public static IConfigProperty QuestOverlayYProperty;
    public static float QuestOverlayY = 14;

    public static IConfigProperty QuestOverlayScaleProperty;
    public static int QuestOverlayScale = 246;

    public static IConfigProperty QuestOverlayTextAlignProperty;
    public static int QuestOverlayTextAlign = 0; // 0: Left, 1: Center, 2: Right

    public static IConfigProperty CompassEnabledProperty;
    public static boolean CompassEnabled = true;

    public static IConfigProperty CompassOverlayXProperty;
    public static float CompassOverlayX = 36;

    public static IConfigProperty CompassOverlayYProperty;
    public static float CompassOverlayY = 0;

    public static IConfigProperty CompassOverlayScaleProperty;
    public static int CompassOverlayScale = 344;

    public static IConfigProperty CompassOverlayWidthProperty;
    public static int CompassOverlayWidth = 158;

    // Ability Hotbar HUD
    public static IConfigProperty AbilityHotbarEnabledProperty;
    public static boolean AbilityHotbarEnabled = true;

    public static IConfigProperty AbilityHotbarXProperty;
    public static float AbilityHotbarX = 0;

    public static IConfigProperty AbilityHotbarYProperty;
    public static float AbilityHotbarY = 43;

    public static IConfigProperty AbilityHotbarScaleProperty;
    public static int AbilityHotbarScale = 227;

    public static IConfigProperty AbilityHotbarHorizontalProperty;
    public static boolean AbilityHotbarHorizontal = false;

    public static IConfigProperty AbilityHotbarAltTextureProperty;
    public static boolean AbilityHotbarAltTexture = true;

    // 1=Above(H)/Left(V), 2=Below(H)/Right(V)
    public static IConfigProperty AbilityHotbarTextPositionProperty;
    public static int AbilityHotbarTextPosition = 2;

    // Max visible slots: 3, 5, or 7
    public static IConfigProperty AbilityHotbarVisibleSlotsProperty;
    public static int AbilityHotbarVisibleSlots = 5;

    // Show Always: true = always visible, false = only visible while HUD key held
    public static IConfigProperty AbilityHotbarShowAlwaysProperty;
    public static boolean AbilityHotbarShowAlways = true;

    // Text Visibility: 0=Shown, 1=Hidden, 2=Held (only while HUD key held)
    public static IConfigProperty AbilityHotbarTextVisibilityProperty;
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            QuestOverlayY = (float) QuestOverlayYProperty.getDouble(14);
            ...
            LowResExplosionProperty = config.get(
                ...
                "Low Res IExplosion",
                false,
                "Disables most Energy IExplosion voxel rendering and keeps particle effects only."
            );
            ...
            FMLLog.log(Level.ERROR, e, "CNPC+ has had a problem loading its client IConfiguration");
        } finally {
