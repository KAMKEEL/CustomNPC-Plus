...
public class ConfigScript {
     ...
     * General Properties
     **/
    public static IConfigProperty ScriptingEnabledProperty;
    public static boolean ScriptingEnabled = true;

    public static IConfigProperty ScriptOpsOnlyProperty;
    public static boolean ScriptOpsOnly = false;

    public static IConfigProperty GlobalPlayerScriptsProperty;
    public static boolean GlobalPlayerScripts = true;

    public static IConfigProperty GlobalForgeScriptsProperty;
    public static boolean GlobalForgeScripts = true;

    public static IConfigProperty GlobalNPCScriptsProperty;
    public static boolean GlobalNPCScripts = false;

    /**
     * Customization Properties
     **/
    public static IConfigProperty ScriptingECMA6Property;
    public static boolean ScriptingECMA6 = false;

    public static IConfigProperty ExpandedScriptLimitProperty;
    public static int ExpandedScriptLimit = 2;

    public static IConfigProperty ScriptDevIDsProperty;
    public static String ScriptDevIDs = "";

    public static IConfigProperty EnableBannedClassesProperty;
    public static boolean EnableBannedClasses = false;

    public static IConfigProperty RunLoadedScriptsFirstProperty;
    public static boolean RunLoadedScriptsFirst = true;

    public static IConfigProperty BannedClassesProperty;
    public final static HashSet<String> BannedClasses = new HashSet<>();

    public static int ActionManagerTickDefault = 5;

    public static IConfigProperty ClearActionsOnDeathProperty;
    public static boolean ClearActionsOnDeath = true;

    public static IConfigProperty ShowImplementationFieldsInAutocompleteProperty;
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            FMLLog.log(Level.ERROR, e, "CNPC+ has had a problem loading its scripting IConfiguration");
        } finally {
    ...
    public static boolean isScriptDev(IPlayer player) {
        return Developer.ScriptUser.contains(player.getUniqueID()) || Developer.Universal.contains(player.getUniqueID());
    }

    public static boolean canScript(IPlayer player, CustomNpcsPermissions.Permission perm) {
        boolean isOp = PlatformServiceHolder.get().getServer().getConfigurationManager().func_152596_g(player.getGameProfile());
