...
public class ConfigDebug {
     ...
     * Logging Properties
     **/
    public static IConfigProperty PlayerLoggingProperty;
    public static boolean PlayerLogging = false;

    public static IConfigProperty ScriptLoggingProperty;
    public static boolean ScriptLogging = false;

    public static IConfigProperty ScriptFrequencyProperty;
    public static int ScriptFrequency = 20;

    public static IConfigProperty ScriptIgnoreTimeProperty;
    public static int ScriptIgnoreTime = 2000;

    public static IConfigProperty ScriptLogIgnoreTypeProperty;
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            FMLLog.log(Level.ERROR, e, "CNPC+ has had a problem loading its debug IConfiguration");
        } finally {
