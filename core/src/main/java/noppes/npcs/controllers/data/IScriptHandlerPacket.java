...
public interface IScriptHandlerPacket extends IScriptHandler {
     ...
     */
    void sendSavePacket(int index, int totalCount, INbt nbt);
     ...
     */
    default GuiDataResult setGuiData(INbt compound) {
        ...
        INbt scriptCompound = compound.getCompoundTag("Script");
    ...
    default void sync() {
        ...
        for (int i = 0; i < containers.size(); i++) {
            ...
            sendSavePacket(i, containers.size(), container.writeToNBT(new INbt()));
        }
