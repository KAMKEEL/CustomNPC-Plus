...
public class AuctionClaim implements IAuctionClaim {
    ...
    public IItemStack item;          // The item (for ITEM claims only)
     ...
     */
    public static AuctionClaim createItemWonClaim(UUID playerUUID, String playerName, String listingId, IItemStack item) {
     ...
     */
    public static AuctionClaim createItemReturnedClaim(UUID playerUUID, String playerName, String listingId, IItemStack item) {
        AuctionClaim claim = new AuctionClaim();
        claim.playerUUID = playerUUID;
        claim.playerName = playerName;
        claim.listingId = listingId;
     ...
     */
    public static AuctionClaim createRefundClaim(UUID playerUUID, String playerName, String listingId, long currency, String itemName, String outbidderName, IItemStack item) {
        AuctionClaim claim = new AuctionClaim();
        claim.playerUUID = playerUUID;
        claim.playerName = playerName;
        claim.listingId = listingId;
    ...
    public void readFromNBT(INbt compound) {
        ...
        if (compound.hasKey("Item")) {
            item = IItemStack.loadItemStackFromNBT(compound.getCompoundTag("Item"));
        } else {
            item = null;
        }
    ...
    public static AuctionClaim fromNBT(INbt compound) {
        AuctionClaim claim = new AuctionClaim();
