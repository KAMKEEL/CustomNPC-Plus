...
public class Dialog implements ICompatibilty, IDialog {
    ...
    public boolean hasDialogs(IPlayer player) {
    ...
    public void readNBTPartial(INbt compound) {
        ...
        colorData.readFromNBT(new NBTWrapper(compound));
    }
    ...
    public INbt writeToNBTPartial(INbt compound) {
        ...
        INbtList options = new INbtList();
        for (int opslot : this.options.keySet()) {
            INbt listcompound = new INbt();
        ...
        colorData.writeToNBT(new NBTWrapper(compound));
        ...
        INbtList images = new INbtList();
        for (IDialogImage dialogImage : dialogImages.values()) {
            INbt imageCompound = ((NBTWrapper) ((DialogImage) dialogImage).writeToNBT(new NBTWrapper(new INbt()))).getMCTag();
    ...
    public Dialog copy(IPlayer player) {
