...
public class AuctionListing implements IAuctionListing {
    ...
    public AuctionListing(UUID sellerUUID, String sellerName, IItemStack item, long startingPrice, long buyoutPrice, long durationMs) {
        this();
    ...
    public static AuctionListing fromNBT(INbt compound) {
