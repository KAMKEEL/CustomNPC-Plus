...
public class VaultUtil {
     ...
     */
    public static boolean hasAccount(IPlayer player) {
     ...
     */
    public static double getBalance(IPlayer player) {
     ...
     */
    public static boolean has(IPlayer player, double amount) {
     ...
     */
    public static boolean withdrawMoney(IPlayer player, double amount) {
     ...
     * @return true if the transaction was successful
     */
    public static boolean addMoney(IPlayer player, double amount) {
     ...
     * @return true if the transaction was successful
     */
    public static boolean setBalance(IPlayer player, double amount) {
     ...
     */
    public static boolean createAccount(IPlayer player) {
     ...
     */
    public static boolean transfer(IPlayer from, IPlayer to, double amount) {
