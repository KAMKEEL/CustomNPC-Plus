...
import kamkeel.npcs.controllers.data.ability.data.energy.PanelData;

/**
 * TEMPORARY STUB -- auto-generated for compilation.
 * Entity for energy panels. Actual entity stays in mc1710.
 */
public class EntityEnergyPanel {
    public double posX, posY, posZ;
    public PanelData getPanelData() { return new PanelData(); }
    public void setDead() {}
}
