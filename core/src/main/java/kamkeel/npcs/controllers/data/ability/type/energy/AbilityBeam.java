...
public class AbilityBeam extends AbilityEnergyProjectile<EntityAbilityBeam> implements IAbilityEnergyBeam {
    ...
    @Override
    protected EntityAbilityBeam createEntity(IEntityLivingBase caster, IEntityLivingBase target,
    ...
    @Override
    protected void fireEntity(EntityAbilityBeam beam, IEntityLivingBase target) {
        if (isPreview()) {
    ...
    @Override
    protected void setupEntityPreview(EntityAbilityBeam beam, IEntityLivingBase caster,
