...
public class AbilitySlicer extends AbilityEnergyProjectile<EntityEnergySlicer> {
    ...
    @Override
    protected EntityEnergySlicer createEntity(IEntityLivingBase caster, IEntityLivingBase target,
    ...
    @Override
    protected void fireEntity(EntityEnergySlicer slicer, IEntityLivingBase target) {
        if (isPreview()) {
    ...
    @Override
    protected void setupEntityPreview(EntityEnergySlicer slicer, IEntityLivingBase caster,
