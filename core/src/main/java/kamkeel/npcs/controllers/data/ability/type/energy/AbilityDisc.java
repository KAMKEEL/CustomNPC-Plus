...
public class AbilityDisc extends AbilityEnergyProjectile<EntityAbilityDisc> implements IAbilityDisc {
    ...
    @Override
    protected EntityAbilityDisc createEntity(IEntityLivingBase caster, IEntityLivingBase target,
    ...
    @Override
    protected void fireEntity(EntityAbilityDisc disc, IEntityLivingBase target) {
        if (isPreview()) {
    ...
    @Override
    protected void setupEntityPreview(EntityAbilityDisc disc, IEntityLivingBase caster,
