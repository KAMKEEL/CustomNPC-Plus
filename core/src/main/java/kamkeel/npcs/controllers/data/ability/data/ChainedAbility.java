 ...
 * delay IConfiguration. Individual ability conditions are skipped during chain execution.
 * <p>
...
public class ChainedAbility implements IChainedAbility, IAbilityAction {
     ...
     */
    private INbt customData = new INbt();
    ...
    public INbt writeNBT(boolean saveScripts) {
        ...
        // Entries
        INbtList entryList = new INbtList();
        for (ChainedAbilityEntry entry : entries) {
    ...
    public void readNBT(INbt nbt) {
        ...
        // Entries
        entries.clear();
        INbtList entryList = nbt.getTagList("Entries", 10);
