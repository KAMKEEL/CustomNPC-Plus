 ...
 * to execute in sequence along with its delay IConfiguration.
 * <p>
...
public class ChainedAbilityEntry {
    ...
    public boolean convertToInline() {
        ...
        INbt nbt = resolved.writeNBT(true);
    ...
    public static ChainedAbilityEntry fromNBT(INbt nbt) {
        ...
        if (nbt.hasKey("InlineAbility")) {
            INbt abilityNBT = nbt.getCompoundTag("InlineAbility");
            entry.entryType = EntryType.INLINE;
