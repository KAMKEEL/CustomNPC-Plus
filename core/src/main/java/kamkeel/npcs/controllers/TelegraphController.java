...
public class TelegraphController implements ITelegraphHandler {
     ...
     *
     * @param telegraph The telegraph IConfiguration
     ...
     */
    public TelegraphInstance spawn(Telegraph telegraph, IWorld IWorld, double x, double y, double z, float yaw) {
        TelegraphInstance instance = new TelegraphInstance(telegraph, x, y, z, yaw);
        instance.setWorld(IWorld);
        activeInstances.put(instance.getInstanceId(), instance);
        TelegraphSpawnPacket.sendToDimension(instance, IWorld.provider.dimensionId);
        return instance;
    }
     ...
     */
    public TelegraphInstance spawn(Telegraph telegraph, IWorld IWorld, double x, double y, double z) {
        return spawn(telegraph, IWorld, x, y, z, 0);
    }

    /**
     * Spawn a telegraph that follows an IEntity.
     *
     * @param telegraph The telegraph IConfiguration
     * @param IEntity    The IEntity to follow
     * @return The spawned telegraph instance
     */
    public TelegraphInstance spawn(Telegraph telegraph, IEntity IEntity) {
        return spawn(telegraph, IEntity, 0);
    }

    /**
     * Spawn a telegraph that follows an IEntity with yaw.
     */
    public TelegraphInstance spawn(Telegraph telegraph, IEntity IEntity, float yaw) {
        TelegraphInstance instance = new TelegraphInstance(telegraph, IEntity.posX, IEntity.posY, IEntity.posZ, yaw);
        instance.setWorld(IEntity.worldObj);
        instance.setEntityIdToFollow(IEntity.getEntityId());
        activeInstances.put(instance.getInstanceId(), instance);
        TelegraphSpawnPacket.sendToTracking(instance, IEntity);
        return instance;
    }
     ...
     */
    public TelegraphInstance spawnToPlayer(Telegraph telegraph, IPlayer player, double x, double y, double z, float yaw) {
        TelegraphInstance instance = new TelegraphInstance(telegraph, x, y, z, yaw);
     ...
     */
    public TelegraphInstance spawnToAll(Telegraph telegraph, IWorld IWorld, double x, double y, double z, float yaw) {
        TelegraphInstance instance = new TelegraphInstance(telegraph, x, y, z, yaw);
        instance.setWorld(IWorld);
        activeInstances.put(instance.getInstanceId(), instance);
    ...
    /**
     * Spawn a telegraph to all players tracking an IEntity.
     */
    public TelegraphInstance spawnToTracking(Telegraph telegraph, IEntity IEntity, double x, double y, double z, float yaw) {
        TelegraphInstance instance = new TelegraphInstance(telegraph, x, y, z, yaw);
        instance.setWorld(IEntity.worldObj);
        activeInstances.put(instance.getInstanceId(), instance);
        TelegraphSpawnPacket.sendToTracking(instance, IEntity);
     ...
     */
    public void removeFromPlayer(String instanceId, IPlayer player) {
     ...
     * @param telegraph The telegraph IConfiguration to save
     */
     ...
     * @return The telegraph IConfiguration, or null if not found
     */
    ...
    @Override
    public ITelegraphInstance spawn(ITelegraph telegraph, IWorld IWorld, double x, double y, double z) {
        return spawn(telegraph, IWorld, x, y, z, 0);
    }

    @Override
    public ITelegraphInstance spawn(ITelegraph telegraph, IWorld IWorld, double x, double y, double z, float yaw) {
        if (telegraph == null || IWorld == null) return null;
        Telegraph internal = ((ScriptTelegraph) telegraph).getMCTelegraph();
        TelegraphInstance instance = spawn(internal, (IWorld) IWorld.getMCWorld(), x, y, z, yaw);
        return new ScriptTelegraphInstance(instance);
    }

    @Override
    public ITelegraphInstance spawn(ITelegraph telegraph, IEntity IEntity) {
        return spawn(telegraph, IEntity, 0);
    }

    @Override
    public ITelegraphInstance spawn(ITelegraph telegraph, IEntity IEntity, float yaw) {
        if (telegraph == null || IEntity == null) return null;
        Telegraph internal = ((ScriptTelegraph) telegraph).getMCTelegraph();
        TelegraphInstance instance = spawn(internal, (IEntity) IEntity.getMCEntity(), yaw);
        return new ScriptTelegraphInstance(instance);
    }
